...
flags.DEFINE_float('constrain', 3., 'connectivity constraint between 2 uavs')
>>>>>>> 224c5661477495143927fe4c6ec825a3d4435edc
flags.DEFINE_integer('max_epoch', 500, 'the max epoch')
flags.DEFINE_float('max_speed', 1., 'max value of speed')
flags.DEFINE_float('factor', 1., 'energy(honor) / energy(max distance)')
