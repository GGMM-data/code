...
def conv2d(inputs, output_dim, kernel_size, stride, initializer, activation_fn, padding='VALID', data_format='NHWC', name="conv2d"):
...
def linear(inputs, output_size, stddev=0.02, bias_start=0.0, activation_fn=None, name='linear'):
