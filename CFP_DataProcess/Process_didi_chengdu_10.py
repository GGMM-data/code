...
class inflow_outflow():
	...
	def create_inflow_outflow(self):
		for file in self.files:
			...
			inflow_outflow_raw_data_pathname = self.parent_dir + str(self.time_interval) + "_" + str(
				self.begin_long) + "_" + str(self.end_long) + "_" + str(self.begin_lati) + "_" + str(
				self.end_lati) + "_" + str(self.m) + "_" + str(self.n) + "/inflow_outflow_raw_data_" + file
			self.process_long_lati_one_trajectory_didi(trajectory, inflow_outflow_raw_data_pathname)
...
def main():
	...
	# 2.生成h5文件的存储路径
	h5_file_name = "./info_didi/TaxiDD_" + str(begin_long) + "_" + str(end_long) + "_" + str(begin_lati) + "_" + str(
		end_lati) + "_" + str(time_interval) + "_" + str(m) + "_" + str(n) + "_" + str(nb_flows) + "_count.h5"
	...
	pathname = parent_dir + str(time_interval) + "_" + str(begin_long) + "_" + str(end_long) + "_" + str(
		begin_lati) + "_" + str(end_lati) + "_" + str(m) + "_" + str(n) + "/"
	
	with open("./info_didi/" + str(time_interval) + "_" + str(begin_long) + "_" + str(end_long) + "_" + str(
			begin_lati) + "_" + str(end_lati) + "_" + str(m) + "_" + str(n) + ".files", "w") as f:
