...
def train(arglist, restore_model_number):
    ...
    with U.single_threaded_session():
        ...
        # 1.4 加载checkpoints
        if arglist.load_dir == "":
            arglist.load_dir = os.path.join(save_path, str(restore_model_number), "model.ckpt")
        ...
        for i in range(num_tasks):
            ...
            list_of_taskenv[i].set_map(
                        sample_map(arglist.test_data_dir + arglist.test_data_name + "_" + str(i + 1) + ".h5"))
            ...
            for task_index in range(num_tasks):
                ...
                if done or terminal:
                    ...
                    draw_util.draw_single_episode(
                        arglist.pictures_dir_transfer_train + model_name + "single_episode_task_" + str(task_index) + "/",
                        episode_number,
                        temp_efficiency,
                    ...
                    with open(arglist.pictures_dir_transfer_train + model_name + "task_" + str(task_index) + '_train_info' + '.txt', 'a+') as f:
                ...
                if terminal and (episode_number % arglist.save_rate == 0):
                    ...
                    if arglist.draw_picture_train:
                        ...
                        draw_util.draw_episodes(
                            episode_number,
                            arglist.pictures_dir_transfer_train + model_name + "all_episodes_task_" + str(task_index) + "/",
