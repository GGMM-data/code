...
from experiments.ops import make_env, get_trainers, time_begin, time_end
        ...
        with U.single_threaded_session():
                ...
                while True:
                        for task_index in range(num_tasks):
                                ...
                                current_trainer = trainers_list[task_index]
                                action_n = []
                                # 用critic获得state,用critic给出action，
                                for agent, his in zip(current_trainer, history_n[task_index]):
                                ...
                                new_obs_n, rew_n, done_n, _ = current_env.step(action_n)
                                ...
                                for trainer in current_trainer:
                                        trainer.preupdate()
                                for trainer in current_trainer:
                                        trainer.update(current_trainer, global_steps[task_index])
                                if debug:
